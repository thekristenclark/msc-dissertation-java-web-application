...
@SpringBootTest(classes = { WritingApplication.class })
...
//        mvc.perform(get("/editor").with(httpBasic(USER_NAME, PASSWORD)))
//                .andExpect(status().isOk());
//    }
//
//    @Test
//    void givenUserNotExists_whenInvokeEndPoint_thenReturn401() throws Exception {
//        mvc.perform(get("/editor").with(httpBasic("not_existing_user", "password")))
//                .andExpect(status().isUnauthorized());
//    }
//
//    @Test
//    void givenUserExistsAndWrongPassword_whenInvokeEndPoint_thenReturn401() throws Exception {
//        mvc.perform(get("/editor").with(httpBasic(USER_NAME, "wrong_password")))
//                .andExpect(status().isUnauthorized());
//    }
//
//    @Test
...
//        mvc.perform(get("/editor").with(httpBasic(ADMIN_NAME, PASSWORD)))
//                .andExpect(status().isOk());
//
//        mvc.perform(get("/editor").with(httpBasic(ADMIN_NAME, PASSWORD)))
//                .andExpect(status().isOk());
