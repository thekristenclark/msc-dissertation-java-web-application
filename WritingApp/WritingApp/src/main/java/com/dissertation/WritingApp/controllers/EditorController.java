...
//            model.addAttribute("diagramData", editor.getDiagramData());
    ...
    @PostMapping("/editor")
    public String submitEditorForm(@ModelAttribute Editor editor, @RequestParam("diagramData") String diagramData, @RequestParam("charNotes") String charNotes, @RequestParam("story") String story, Model model) {
